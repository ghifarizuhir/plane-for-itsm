...
def workspace_seed(workspace_id: uuid.UUID) -> None:
    ...
    try:
        ...
        bot_user = User.objects.create(
            ...
            display_name="Terraline",
            first_name="Terraline",
            last_name="",
            is_bot=True,
            bot_type=BotTypeEnum.WORKSPACE_SEED,
            email=f"bot_user_{workspace.id}@{urlparse(settings.WEB_URL or 'https://terraline.space').hostname or 'terraline.space'}",
