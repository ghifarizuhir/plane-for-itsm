...
paths=(
  ...
  "/api/workspaces/$WS/projects/$P/modules/00000000-0000-0000-0000-000000000000/"
  "/api/workspaces/$WS/projects/$P/states/"
  "/api/workspaces/$WS/projects/$P/states/00000000-0000-0000-0000-000000000000/"
  "/api/workspaces/$WS/projects/$P/labels/"
  "/api/workspaces/$WS/projects/$P/labels/00000000-0000-0000-0000-000000000000/"
  ...
  "/api/workspaces/$WS/projects/$P/intake-issues/00000000-0000-0000-0000-000000000000/"
  ...
  "/api/workspaces/$WS/projects/$P/views/00000000-0000-0000-0000-000000000000/"
  "/api/workspaces/$WS/views/"
  "/api/workspaces/$WS/views/00000000-0000-0000-0000-000000000000/"
  "/api/workspaces/$WS/projects/$P/members/00000000-0000-0000-0000-000000000000/"
  "/api/workspaces/$WS/projects/$P/pages/00000000-0000-0000-0000-000000000000/"
  "/api/workspaces/$WS/webhooks/00000000-0000-0000-0000-000000000000/"
