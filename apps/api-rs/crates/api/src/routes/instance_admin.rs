...
// The decrypt path and env helpers live in `common::crypto` (shared with
// worker/beat) and are re-exported here; the encrypt path stays below.
// ---------------------------------------------------------------------------

use common::crypto::hmac_sha256;
