    ...
    <>
      ...
      <div className="mt-10 flex w-full flex-grow flex-col items-center justify-center py-6">
        <div className="relative flex w-full max-w-[22.5rem] flex-col gap-6">
          <FormHeader
            heading="Setup your Terraline Instance"
            subHeading="Post setup you will be able to manage this Terraline instance."
          />
          {errorData.type &&
            errorData?.message &&
            ...
            <div className="relative flex gap-2">
              <div>
                <Checkbox
                  ...
                  aria-label="Allow Terraline to anonymously collect usage events"
              ...
              <label className="cursor-pointer text-13 font-medium text-tertiary" htmlFor="is_telemetry_enabled">
                Allow Terraline to anonymously collect usage events.{" "}
                <a
                  href="https://developers.terraline.space/self-hosting/telemetry"
                  target="_blank"
